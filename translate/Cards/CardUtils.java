...
public final class CardUtils {
 	...
 	/**
 	* Uses reflection to print out every string member variable in card onto one string.
 	* Card {
	*   String foo = "foo"
	*   String bar = "bar"
 	* }
	...
	public static String findNextLineAndRemoveStars(Scanner scan) {
	...
	public static boolean verify(String className) throws FileNotFoundException, java.lang.Exception {
	  ...
	  Constructor<?> ctor = clazz.getConstructor(Scanner.class);
